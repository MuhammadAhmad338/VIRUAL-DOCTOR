...
class EmergencyContactsProvider with ChangeNotifier {
  List<EmergencyContacts> _emergencyContacts = [
    ...
    EmergencyContacts(name: 'Police', phone: '15', userid: '3'),
    EmergencyContacts(name: 'Rangers', phone: '1011', userid: '4'),
    EmergencyContacts(
    ...
    EmergencyContacts(name: 'Fire Brigade', phone: '16', userid: '8'),
    EmergencyContacts(name: 'Women Helpline', phone: '1094', userid: '9'),
    EmergencyContacts(
